    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.item2:
                ...
                return true;
            case R.id.sub_item1:
                Toast.makeText(MainActivity.this, "Sub_Item1 selected", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.sub_item2:
                Toast.makeText(MainActivity.this, "Sub_Item2 selected", Toast.LENGTH_SHORT).show();
                return true;
            default:
